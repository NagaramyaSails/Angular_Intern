...
const checkDogs = function (dogsJulia, dogsKate) {
  ...
  console.log(`Dogs : ${dogsTotal}`);
  dogsTotal.forEach(function (dog, i) {
    //const dogType = dog >= 3 ? "an adult" : "a puppy;";
    //console.log(`Dog number ${i + 1} is ${dogType}, and is ${dog} years ols`);
    if (dog >= 3) {
...
1. Calculate the dog age in human years using the following formula: if the dog is <= 2 years old, humanAge = 2 * dogAge. If the 
...
const avgNew1 = calcAverageHumanAgeNew([5, 2, 4, 1, 15, 8, 3]);
const avgNew2 = calcAverageHumanAgeNew([16, 6, 10, 5, 6, 1, 4]);
console.log(
  `Averages of adult dogs ages using chaining methods : \nAvg1: ${avgNew1}\nAvg2 : ${avg2}`
);
